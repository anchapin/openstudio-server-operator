...
```bash
ruff check . && pytest                       # both green (1272 tests across 58 files, current count)
...
local; the scrape is in-cluster). The exhaustive inventory — **26 counters + 19 gauges + 5 histograms** — is asserted by the canonical
