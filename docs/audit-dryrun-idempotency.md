...
```bash
ruff check . && pytest                       # both green (971 tests across 45 files, current count)
...
dry-run-gated action could exist). The post-#491 expansion to 20+16+5
